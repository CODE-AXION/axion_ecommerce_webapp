            ...
            <div class="card_1 swiper-slide ">
                <a href="{{route('product.show',['id'=> $p_product->id,'slug'=>$p_product->slug])}}">
                    ...
                    <div class="card_panel">
                        ...
                        <div class="card_readmore"><span>$ {{$p_product->sale_price}}</span></div>
        ...
        <div class="card_1 swiper-slide ">
            <a href="{{route('product.show',['id'=> $r_product->id,'slug'=>$r_product->slug])}}">
                ...
                <div class="card_panel">
                    ...
                    <div class="card_readmore"><span>$ {{$r_product->sale_price}}</span></div>
                    <button class="btn-buy_now"><a href="">BUY NOW</a></button>
                </div>
            </a>
        </div>
...
@else
    <h2>Sorry No related Products Found For This Products</h2>
@endif
